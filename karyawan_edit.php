  ...
  <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Nama</td>
                                                <td>
                                                <input type="text" class="form-control" name="nama" Required autocomplete="off" value="<?php echo $d['nama'];?>">
                                                	</td>
                                            </tr>
                                            ...
                                            <tr>
                                            	...
                                            	<td>
                                              <input type="text" class="form-control" name="tmp_tgl_lahir" Required autocomplete="off" value="<?php echo $d['tmp_tgl_lahir'];?>">
                                            		</td>
                                            </tr>
                                            ...
                                            <TR>
                                            	<td>Jenis Kelamin</td>
                                            	<td>
                                            		 <select select class="form-control" name="jenkel" Required>
                                             ...
                                             <tr>
                                                <td>Agama</td>
                                                <td>
                                                	  <select  select class="form-control" name="agama" Required>
                                           ...
                                           <tr>
                                              <td>Alamat</td>
                                              <td><textarea autocomplete="off" class="form-control" name="alamat" Required value="<?php echo $d['alamat'];?>"></textarea><td>
                                           </tr>

                                           <tr>
                                           	<td>Nomor Telepon</td>
                                           	<td>
                                             <input type="text" class="form-control"  name="no_tel" Required value="<?php echo $d['no_tel'];?>">
                                           		</td>
                                           </tr>
