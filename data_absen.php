 ...
 ?>
    <div class="page-wrapper">
        ...
        if($_POST['carinama']!='' && $_POST['txtTglAwal']!='' && $_POST['txtTglAkhir']!='') {
            ...
            $hadir = mysqli_query($koneksi, "SELECT * FROM tb_absen WHERE status_absen = 'Hadir' AND nama LIKE '%$carinama%' AND date_format(str_to_date(tanggal, '%d-%m-%Y'), '%Y-%m-%d') BETWEEN '".$tglAwal."' AND '".$tglAkhir."'");
            ...
            $bekerja = mysqli_query($koneksi, "SELECT * FROM tb_absen WHERE status_absen = 'Bekerja' AND nama LIKE '%$carinama%' AND date_format(str_to_date(tanggal, '%d-%m-%Y'), '%Y-%m-%d') BETWEEN '".$tglAwal."' AND '".$tglAkhir."'");
        }
