                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>NIP</td>
                                                <td>
                                                	<input type="text" class="form-control" value="<?php echo $r['id_karyawan'];?>" name="id_karyawan" Required>
                                            ...
                                            <tr>
                                                <td>Nama</td>
                                                <td>
                                                	<input type="text" class="form-control" name="nama" Required value="<?php echo $r['nama'];?>">
                                                	</td>
                                            </tr>
                                            ...
                                            <tr>
                                            	...
                                            	<td>
                                            		<input type="text" class="form-control" value="<?php echo $r['tmp_tgl_lahir'];?>" name="tmp_tgl_lahir" Required>
                                            		</td>
                                            </tr>
                                           ...
                                           <tr>
                                              <td>Alamat</td>
                                              <td><textarea autocomplete="off" class="form-control" name="alamat" Required value="<?php echo $r['alamat'];?>"></textarea></td>
                                           </tr>

                                           <tr>
                                           	<td>Nomor Telepon</td>
                                           	<td>
                                           		<input type="text" class="form-control" name="no_tel" Required value="<?php echo $r['no_tel'];?>">
                                           		</td>
                                           </tr>
