...
if($status_absen == "Masuk"){
	$save = "INSERT INTO tb_absen SET id_karyawan='$id_karyawan', nama='$nama', hari='$hari', tanggal='$tanggal', waktu_masuk='$waktu_masuk', waktu_pulang='', status_absen='Bekerja',
	pekerjaan='$pekerjaan', latitude='$latitude', longitude='$longitude', jadwal='$schedule'";
...
elseif($status_absen == "Pulang"){
	...
	if($cek>0){
		...
		$update = "UPDATE tb_absen SET waktu_pulang='$waktu_pulang',status_absen='Hadir', pekerjaan='$pekerjaan' WHERE id_karyawan='$id_karyawan' AND tanggal='$tanggal'";
